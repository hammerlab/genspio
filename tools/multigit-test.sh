...
try_cmd "$gmstest | grep ketrew   | $sedstuff | grep '^|0|0|0|0|0|0|$' "
try_cmd "$gmstest | grep biokepi  | $sedstuff | grep '^|0|2|0|0|0|0|$' "
try_cmd "$gmstest | grep coclobas | $sedstuff | grep '^|1|1|0|0|0|0|$' "
